...
class TestQuerySensorNetWorkGraph:
    ...
    @pytest.mark.parametrize(argnames="cases", argvalues=HandleExcle(file_path() + "/data/SystemMonitoring.xlsx", "querySensorNetWorkGraph").read_data())
    def test_querySensorNetWorkGraph(self, cases, start_up):
