...
@allure.epic("总览")
class TestGetEsNodeInfo:
    @pytest.mark.parametrize(argnames="cases", argvalues=HandleExcle(file_path() + "/data/SystemMonitoring.xlsx", "getEsNodeInfo").read_data())
    def test_getEsNodeInfo(self, cases, start_up):
