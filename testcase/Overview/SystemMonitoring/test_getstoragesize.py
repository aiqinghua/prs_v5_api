...
class TestGetStorageSize:
    @pytest.mark.parametrize(argnames="cases", argvalues=HandleExcle(file_path() + "/data/SystemMonitoring.xlsx", "getStorageSize").read_data())
    def test_getStorageSize(self, cases, start_up):
